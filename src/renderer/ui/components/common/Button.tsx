...
export function Button({
  ...
  const visualTone: Record<ButtonVariant, VariantTone> = {
    ...
    secondary: {
      ...
      innerFrameClass: isDisabled ? 'border-[#615140]/40' : isHover ? 'border-[#c9a84c]/60' : 'border-[#8a6d2b]/50',
      textClass: isDisabled ? 'text-[#8c785a]' : 'text-[#c9a84c]',
      topBeamClass: isDisabled ? 'bg-[#907a63]/24' : isHover ? 'bg-[#b5884b]/40' : 'bg-[#866234]/36',
      bottomBeamClass: isDisabled ? 'bg-[#120a07]/22' : isHover ? 'bg-[#2a180d]/52' : 'bg-[#140c08]/46',
      ...
      backgroundBase: 'linear-gradient(180deg, rgba(52,34,20,0.96) 0%, rgba(65,42,25,0.95) 48%, rgba(72,48,28,0.96) 100%)',
      texture: bronzeTexture,
      textureOpacity: 0.11,
      showStuds: true,
      showInnerFrame: true,
